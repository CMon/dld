 /*
  * main.cpp  -  domestic location detection - main for person data administration application
  *
...
int main (int argc, char * argv[])
{
	...
	DLDPersonDataAdmin * mainPDAdmin = new DLDPersonDataAdmin (verbosity, logFile);
